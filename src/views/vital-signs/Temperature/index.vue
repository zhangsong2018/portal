<template>
  <div id="app" v-title="title">
    <div class="wrap">
      <HeaderBar @on-hand='toHnad'>体温</HeaderBar>
      <section class="section">
        ...
        <div class="content_box"  style="border: none">
          ...
          <span class="center"><input type="number" v-model="temperature" class="t_width" oninput="if(value.length>4)value=value.slice(0,4)"></span>
        ...
        <div class="footer">
          <p class="yuyin_dome">您可以说:体温36.7度</p>
...
<script>
  ...
  import {Toast, Confirm,AlertModule,Cell,Alert,Loading,Datetime, Group, XSwitch, XButton,TransferDomDirective as TransferDom} from 'vux'
  ...
  export default {
    ...
    toParent() {},
      ...
      toHistory(){
           this.create(false);
           this.$router.push({
              path: 'History/HistoryTemperature',
