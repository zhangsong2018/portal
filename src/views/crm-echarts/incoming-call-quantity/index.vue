<template>
  <div id="wrap">
    ...
    <section class="section">
      ...
      <div id="incomingCallQuantity"></div>
      <table class="table">
        <thead>
        <tr>
          <th>日期</th>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      setOption(){
        let myChart = echarts.init(document.getElementById('incomingCallQuantity'));
        let option = {
          color: colors,
            title:{
            text:'',
