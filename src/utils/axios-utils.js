...
axios.interceptors.request.use(config => {
  // 处理请求之前的配置 显示loading
  config.headers.common['Authorization'] = 'Bearer ' + Authorization || "";
  config.headers.common['Oms-Tenant-Id'] = localStorage.getItem("tenantId") ? localStorage.getItem("tenantId") : '';
